...
L3-4: grade I degenerative spondylolisthesis with mixed type spinal stenosis involving central canal, mild to moderate degree.

L5-S1: degenerative stenosis of bilateral neuroforamina, moderate to severe degree.


Impression:
Scoliosis with degenerative disc disease, facet joints and degenerative spinal stenosis.


The aim of this CT study is to evaluate ---------------
---------------- CT scan of L-spine performed from L1 -L2, L2-L3, from L3 to L4, from L4 to L5, and from L5 to S1:
1. --------: No definite spinal stenosis.
2. --------: Presence of diffuse/postcentral bulging disk causing mild/moderate/severe spinal stenosis.
3. --------: Presence of diffuse/postcentral bulging disk combined with ligament flavum hypertrophy and facet joint degenerative change causing mild/moderate/severe spinal stenosis.
4. --------: Presence of diffuse/postcentral protrusion disk causing mild/moderate/severe spinal stenosis.
5. --------: Presence of diffuse/postcentral protrusion disk combined with ligament flavum hypertrophy and facet joint degenerative change causing mild/moderate/severe spinal stenosis.
6. --------: Presence of diffuse/postcentral herniation disk causing mild/moderate/severe spinal stenosis.
7. --------: Presence of diffuse/postcentral herniation disk combined with ligament flavum hypertrophy and facet joint degenerative change causing mild/moderate/severe spinal stenosis.
8. --------: Presence of -------- herniated of nucleus pulposus (HIVD), with compression /attachment of the adjacent nerve root/dural sac.
9. --------: Presence of -------- herniated of nucleus pulposus (HIVD), cranial/caudal migration, with compression /attachment of the adjacent nerve root/dural sac.
10. Presence of -------- DJD/spondylolytic type spondylolisthesis over ----------.
11. No evidence of fracture of lumbar spine.
12. Presence of fracture/subluxation over --------------.
13. Presence of soft tissue tumor over ------------------.
14. Presence of bony lesion over ------------------------.
15. Presence of paraspinal/epidural mass/abscess lesion over   ---------.
)
  Paste(MyForm)
Return
...
Coronal T1WI (localizer)
Sagittal TIWI, T2WI, gradient echo T2*WI,
Axial view with gradient echo T2* weighted imaging showed:
...
C2-C3, C3-4, C4-5, C5-6, C6-7, C7-T1: Presence of diffuse bulging disk, causing mild indentation of anterior dural sac, however, no obvious significant spinal stenosis.
...
L1-L2, L2-L3, L3-L4, L4-L5, L5-S1: Presence of posterior-central/right/left/posterior-lateral/lateral herniated nucleus pulposus (HIVD), cranial/caudal migration of this HIVD, with compression /attachment of the adjacent nerve root/dural sac, ligament flavum hypertrophy and facet joint degenerative change  causing mild/moderate/severe degree central spinal stenosis and mild/moderate/severe narrowing of bilateral lateral recesses and mild/moderate/severe degree degenerative bilateral/right/left neuroforaminal stenosis.
...
Schmorl's node ( vertical intravertebral disc herniation ) over the L1-L2, L2-L3, L3-L4, L4-L5, L5-S1.
